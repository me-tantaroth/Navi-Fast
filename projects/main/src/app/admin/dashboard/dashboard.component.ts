...
import { FixedScaleAxis, IChartOptions, IResponsiveOptionTuple } from 'chartist';
import {
  NgbDate,
  NgbCalendar,
  NgbInputDatepicker,
...
export class DashboardComponent implements OnInit {
  toggleProBanner(event: Event) {
    ...
    this.document.querySelector('body')?.classList.toggle('removeProbanner');
  }
  ...
  performanceIndicatorBarchartResponsiveOptions = <unknown>[
    [
  ...
  doughnutPieLabels!: ['Reassigned', 'Not Assigned', 'Assigned'];
  doughnutPieOptions = {
    cutoutPercentage: 75,
